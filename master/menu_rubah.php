...
<div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Ubah Data Menu Kopi</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                     <form class="form-horizontal" method="post" action="">
                                      <fieldset>
                                        <legend>Form Menu</legend>
										...
										<div class="control-group">
                                          <label class="control-label" for="focusedInput">Harga Menu</label>
                                          <div class="controls">
                                            <input name="c" type="text" class="input-xlarge focused" id="focusedInput" required="true" value="<?php echo $c; ?>"/>
                                          </div>
                                        </div>
...
$b=$_POST['b'];
$c=$_POST['c'];
$query="update menu set nama_menu='$b', harga_menu='$c' where kode_menu='$id'";
$result=mysql_query($query) or mysql_error($query);
	...
	echo"<script>location.href='home.php?page=emenu'</script>";}}
?>